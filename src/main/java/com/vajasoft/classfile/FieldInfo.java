...
public class FieldInfo implements Member, Comparable<FieldInfo> {
    private int accessFlags;
    private String name;
    private String descr;
    private Attribute[] attributes;

    public FieldInfo(java.io.DataInputStream input, Constant[] constantPool) throws java.io.IOException {
    ...
    public String toString() {
        ...
        String type = Descriptor.getFirstType(this);
        buf.append(Util.toExternalClassName(type)).append(' ');
        buf.append(getName());
        return buf.toString();
    }
